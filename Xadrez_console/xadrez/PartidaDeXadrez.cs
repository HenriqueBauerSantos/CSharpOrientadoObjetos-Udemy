...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public Peca executarMovimento(Posicao origem, Posicao destino)
        {
            ...
            //Jogade especial roque pequeno
            if (p is Rei && destino.coluna == origem.coluna + 2)
            {
                Posicao origemTorre = new Posicao(origem.linha, origem.coluna + 3);
                Posicao destioTorre = new Posicao(origem.linha, origem.coluna +1); 
                Peca torre = tab.retirarPeca(origemTorre);
                torre.incrementarQteMovimentos();
                tab.colocarPeca(torre, destioTorre);
            }

            //Jogade especial roque grande
            if (p is Rei && destino.coluna == origem.coluna - 2)
            {
        ...
        public void desfazerMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if (p is Rei && destino.coluna == origem.coluna + 2)
            {
                Posicao origemTorre = new Posicao(origem.linha, origem.coluna + 3);
                Posicao destioTorre = new Posicao(origem.linha, origem.coluna + 1);
                Peca torre = tab.retirarPeca(destioTorre);
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("A peca de origem escolhida não e sua!");
            }
